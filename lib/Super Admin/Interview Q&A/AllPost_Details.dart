...
class AllPost_Details extends StatefulWidget {
  //Loc_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  AllPost_Details(this.snapshot);

  @override
  _AllPost_DetailsState createState() => _AllPost_DetailsState();
}

class _AllPost_DetailsState extends State<AllPost_Details> {
  @override
