...
class updatepoliticspost extends StatefulWidget {
  DocumentSnapshot snapshot;
  updatepoliticspost(this.snapshot);
  @override
  _updatepoliticspostState createState() => _updatepoliticspostState();
}

class _updatepoliticspostState extends State<updatepoliticspost> {
