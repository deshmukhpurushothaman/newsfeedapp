...
class ScholarshipNews_PostDetails extends StatefulWidget {
  //Int_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  ScholarshipNews_PostDetails(this.snapshot);

  @override
  _ScholarshipNews_PostDetailsState createState() =>
      _ScholarshipNews_PostDetailsState();
}

class _ScholarshipNews_PostDetailsState
    extends State<ScholarshipNews_PostDetails> {
  @override
