...
import 'AdminSportsNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'updatesportspost.dart';
import 'dart:async';
...
class _SportsNewsState extends State<SportsNews> {
  Future getAllPost() async {
    ...
    QuerySnapshot snap =
        // ignore: deprecated_member_use
        await firestore.collection("SportsAllNews").getDocuments();
    // ignore: deprecated_member_use
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.of(context).push(new MaterialPageRoute(
                                  builder: (context) => SportsNews_PostDetails(
                                      snapshot.data[index])));
                            },
                            child: Container(
                              width: 150.0,
