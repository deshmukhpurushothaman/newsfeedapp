...
class updateinternationalpost extends StatefulWidget {
  DocumentSnapshot snapshot;
  updateinternationalpost(this.snapshot);
  @override
  _updateinternationalpostState createState() =>
      _updateinternationalpostState();
}

class _updateinternationalpostState extends State<updateinternationalpost> {
