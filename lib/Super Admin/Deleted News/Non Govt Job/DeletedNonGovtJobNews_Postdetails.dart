...
class DeletedNonGovtJob_PostDetails extends StatefulWidget {
  //Loc_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  DeletedNonGovtJob_PostDetails(this.snapshot);

  @override
  _DeletedNonGovtJob_PostDetailsState createState() =>
      _DeletedNonGovtJob_PostDetailsState();
}

class _DeletedNonGovtJob_PostDetailsState
    extends State<DeletedNonGovtJob_PostDetails> {
  @override
