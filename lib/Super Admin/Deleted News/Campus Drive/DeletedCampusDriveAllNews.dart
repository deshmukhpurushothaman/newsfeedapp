...
import './DeletedCampusDriveNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:async';

class DeletedCampusDrive extends StatefulWidget {
  DeletedCampusDrive({Key key}) : super(key: key);

  @override
  _DeletedCampusDriveState createState() => _DeletedCampusDriveState();
}

class _DeletedCampusDriveState extends State<DeletedCampusDrive> {
  Future getAllPost() async {
    // ignore: deprecated_member_use
    var firestore = Firestore.instance;
    QuerySnapshot snap =
        // ignore: deprecated_member_use
        await firestore.collection("DeletedCampusDrive").getDocuments();
    // ignore: deprecated_member_use
                                        ...
                                        onTap: () {
                                          Navigator.of(context).push(
                                              new MaterialPageRoute(
                                                  builder: (context) =>
                                                      DeletedCampusDrive_PostDetails(
                                                          snapshot
                                                              .data[index])));
                                        },
                                        child: Container(
