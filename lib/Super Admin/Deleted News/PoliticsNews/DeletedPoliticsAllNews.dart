...
import './DeletedPoliticsNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:async';

class DeletedPoliticsNews extends StatefulWidget {
  DeletedPoliticsNews({Key key}) : super(key: key);

  @override
  _DeletedPoliticsNewsState createState() => _DeletedPoliticsNewsState();
}

class _DeletedPoliticsNewsState extends State<DeletedPoliticsNews> {
  Future getAllPost() async {
    // ignore: deprecated_member_use
    var firestore = Firestore.instance;
    QuerySnapshot snap =
        // ignore: deprecated_member_use
        await firestore.collection("DeletedPoliticsNews").getDocuments();
    // ignore: deprecated_member_use
                                        ...
                                        onTap: () {
                                          Navigator.of(context).push(
                                              new MaterialPageRoute(
                                                  builder: (context) =>
                                                      DeletedPoliticsNews_PostDetails(
                                                          snapshot
                                                              .data[index])));
                                        },
                                        child: Container(
