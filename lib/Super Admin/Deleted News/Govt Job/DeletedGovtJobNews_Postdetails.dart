...
class DeletedGovtJob_PostDetails extends StatefulWidget {
  //Int_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  DeletedGovtJob_PostDetails(this.snapshot);

  @override
  _DeletedGovtJob_PostDetailsState createState() =>
      _DeletedGovtJob_PostDetailsState();
}

class _DeletedGovtJob_PostDetailsState
    extends State<DeletedGovtJob_PostDetails> {
  @override
