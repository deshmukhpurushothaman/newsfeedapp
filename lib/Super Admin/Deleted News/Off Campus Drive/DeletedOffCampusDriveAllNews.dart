...
import './DeletedOffCampusDriveNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:async';

class DeletedOffCampusDrive extends StatefulWidget {
  DeletedOffCampusDrive({Key key}) : super(key: key);

  @override
  _DeletedOffCampusDriveState createState() => _DeletedOffCampusDriveState();
}

class _DeletedOffCampusDriveState extends State<DeletedOffCampusDrive> {
  Future getAllPost() async {
    // ignore: deprecated_member_use
    var firestore = Firestore.instance;
    QuerySnapshot snap =
        // ignore: deprecated_member_use
        await firestore.collection("DeletedOffCampusDrive").getDocuments();
    // ignore: deprecated_member_use
                    ...
                    secondaryActions: [
                      IconSlideAction(
                        ...
                        onTap: () => {
                          ...
                          //Delete
                          FirebaseFirestore.instance
                              .collection("DeletedOffCampusDrive")
                                        ...
                                        onTap: () {
                                          Navigator.of(context).push(
                                              new MaterialPageRoute(
                                                  builder: (context) =>
                                                      DeletedOffCampusDrive_PostDetails(
                                                          snapshot
                                                              .data[index])));
                                        },
                                        child: Container(
