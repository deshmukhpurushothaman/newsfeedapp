...
import './DeletedEventsNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:async';

class DeletedEvents extends StatefulWidget {
  DeletedEvents({Key key}) : super(key: key);

  @override
  _DeletedEventsState createState() => _DeletedEventsState();
}

class _DeletedEventsState extends State<DeletedEvents> {
