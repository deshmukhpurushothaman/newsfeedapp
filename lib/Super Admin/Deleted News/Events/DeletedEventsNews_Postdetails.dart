...
class DeletedEvents_PostDetails extends StatefulWidget {
  //Loc_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  DeletedEvents_PostDetails(this.snapshot);

  @override
  _DeletedEvents_PostDetailsState createState() =>
      _DeletedEvents_PostDetailsState();
}
