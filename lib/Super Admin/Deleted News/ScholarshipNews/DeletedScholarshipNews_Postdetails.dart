...
class DeletedScholarshipNews_PostDetails extends StatefulWidget {
  //Int_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  DeletedScholarshipNews_PostDetails(this.snapshot);

  @override
  _DeletedScholarshipNews_PostDetailsState createState() =>
      _DeletedScholarshipNews_PostDetailsState();
}

class _DeletedScholarshipNews_PostDetailsState
