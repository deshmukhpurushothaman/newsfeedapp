...
import './DeletedScholarshipNews_Postdetails.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:async';

class DeletedScholarshipNews extends StatefulWidget {
  DeletedScholarshipNews({Key key}) : super(key: key);

  @override
  _DeletedScholarshipNewsState createState() => _DeletedScholarshipNewsState();
}

class _DeletedScholarshipNewsState extends State<DeletedScholarshipNews> {
                                        ...
                                        onTap: () {
                                          Navigator.of(context).push(
                                              new MaterialPageRoute(
                                                  builder: (context) =>
                                                      DeletedScholarshipNews_PostDetails(
                                                          snapshot
                                                              .data[index])));
                                        },
                                        child: Container(
