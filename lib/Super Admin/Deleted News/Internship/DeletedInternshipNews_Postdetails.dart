...
class DeletedInternship_PostDetails extends StatefulWidget {
  //Loc_PostDetails({Key key}) : super(key: key);

  DocumentSnapshot snapshot;

  DeletedInternship_PostDetails(this.snapshot);

  @override
  _DeletedInternship_PostDetailsState createState() =>
      _DeletedInternship_PostDetailsState();
}

class _DeletedInternship_PostDetailsState
