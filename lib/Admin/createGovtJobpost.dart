...
class createGovtJobpost extends StatefulWidget {
  @override
  _createGovtJobpostState createState() => _createGovtJobpostState();
}

class _createGovtJobpostState extends State<createGovtJobpost> {
