...
class createInternshippost extends StatefulWidget {
  @override
  _createInternshippostState createState() => _createInternshippostState();
}

class _createInternshippostState extends State<createInternshippost> {
