...
class updateWalkinpost extends StatefulWidget {
  DocumentSnapshot snapshot;
  updateWalkinpost(this.snapshot);
  @override
  _updateWalkinpostState createState() => _updateWalkinpostState();
}

class _updateWalkinpostState extends State<updateWalkinpost> {
