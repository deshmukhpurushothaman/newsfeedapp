...
class createWalkinpost extends StatefulWidget {
  @override
  _createWalkinpostState createState() => _createWalkinpostState();
}

class _createWalkinpostState extends State<createWalkinpost> {
