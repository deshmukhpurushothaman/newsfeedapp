...
class updatesportspost extends StatefulWidget {
  DocumentSnapshot snapshot;
  updatesportspost(this.snapshot);
  @override
  _updatesportspostState createState() => _updatesportspostState();
}

class _updatesportspostState extends State<updatesportspost> {
